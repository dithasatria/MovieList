...
public class TrailerFragment extends Fragment {
    ...
    private List<ResultsItemTrailer> items = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new TrailerAdapter(items, getActivity());
    ...
    private void getData(){
        ...
        final Call<APIResponseTrailerMovie> apiResponseCall = apiService.getTrailerMovie(movie_id, BuildConfig.API_KEY, Utility.KEY_LANGUAGE);
        ...
        apiResponseCall.enqueue(new Callback<APIResponseTrailerMovie>() {
            ...
            public void onResponse(Call<APIResponseTrailerMovie> call, Response<APIResponseTrailerMovie> response) {
                ...
                Log.d("trailer cek link", call.toString());
            }
